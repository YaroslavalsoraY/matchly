...
| `AdminDemoDataController.java` | `POST /api/admin/demo-data`: ручной запуск генерации демо-анкет (кнопка в настройках администратора). Идемпотентен. |
